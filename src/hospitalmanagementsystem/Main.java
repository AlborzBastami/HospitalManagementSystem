...
public class Main {
	 ...
	 * Default window, if NO USER is logged in
	 */
	 ...
	 * @param username
	 * @param usertype
	 * Actual Window, WITH USER logged in
	 */
	public void initialize(String username, String usertype) {
		...
		frmHospitalManagementSystem.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmHospitalManagementSystem.getContentPane().setLayout(null);
		frmHospitalManagementSystem.setVisible(true);
